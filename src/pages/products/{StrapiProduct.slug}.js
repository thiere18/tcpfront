  ...
  return (
    <Layout>
          ...
          <div className="mb-4">
            ...
            {product.price && (
              <div className="text-sm flex justify-between">
                <p className="font-extralight">Prix</p>
      ...
      <div className="my-6 mb-24">
        <h1 className="text-4xl font-bold text-center">Description du bien</h1>
      ...
      {product.relatedProducts.length > 0 && (
        <div className="flex flex-col my-6 mb-24">
          <h2 className="text-3xl font-bold text-center">Biens similaires</h2>
          <hr className="mt-6 mb-12 m-auto w-24 border-t-4" />
          <ProductList
